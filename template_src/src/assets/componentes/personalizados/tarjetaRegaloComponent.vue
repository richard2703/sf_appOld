                ...
                <div class="row w-100 m-0 carta px-2" >
                    <div class="row w-100 m-0 py-2 border-b-gray0-1" >
                        ...
                        <div class="row w-100 m-0 py-2 pr-3">
                            <div class="col-auto px-0 ml-auto letra-azul1-18 border-b-azul1-1" @click="show2 = !show2; show = 0;">
                                <template v-if="!show2">Ver QR</template>
                                <template v-else>Ocultar QR</template>
                            </div>
                            <div class="col-auto px-0 ml-auto letra-azul1-18 border-b-azul1-1" @click="show = !show; show2 = 0">
        ...
        <div class="row w-100 m-0 px-2 py-2" >
                <div class="row w-100 m-0 carta px-2" >
                    <div class="row w-100 m-0 py-2 border-b-gray0-1" >
                        ...
                        <div class="col my-auto px-0 pl-3">
                            <div class="row w-100 m-0 letra-azul1-18">Tarjeta ID #{{a.id}}</div>
                            <div class="row w-100 m-0 ">
                                <div class="col px-0 letra-gray4-17">Fecha:</div>
                            ...
                            <div class="row w-100 m-0 ">
                                <div class="col px-0 letra-gray4-17">Total:</div>
                                <div class="col-auto px-0 letra-gray4-19 ">{{a.total | currency}} MXN</div>
                            </div>
                            <div class="row w-100 m-0 ">
                                <div class="col px-0 letra-gray4-17">Gastado:</div>
                                <div class="col-auto px-0 letra-gray4-19 ">{{a.gastado | currency}} MXN</div>
                            </div>
                           
                            <div class="row w-100 m-0 ">
                                <div class="col px-0 letra-gray4-17">Credito:</div>
                                <div class="col-auto px-0 letra-gray4-19 fw-800">{{a.credito | currency}} MXN</div>
                            </div>
                           
                        </div>

                        <div class="row w-100 m-0 py-2 px-3">
                            <div class="col-auto px-0 mr-auto letra-azul1-18 border-b-azul1-1" @click="show2 = !show2; show = 0;">
                                <template v-if="!show2">Ver QR</template>
                                <template v-else>Ocultar QR</template>
                            </div>
                            <div class="col-auto px-0 ml-auto letra-azul1-18 border-b-azul1-1" @click="show = !show; show2 = 0">
                    ...
                    <div class="row w-100 m-0 py-3 " v-if="show2" >
                        <div class="row w-100 m-0 back-color-fondo border-radius-10px ">
                            <div class="row w-100 m-0 py-4">
                                <div class="col-7 px-0 mx-auto">
                                    <imagen :src="`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${a.codigo || 'socialFow'}`" />
                                </div>  
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row w-100 m-0 px-3 " v-if="show">
                        <div class="row w-100 m-0 py-1" v-for="p of a.gastos" :key="p.id">
                            <div class="row w-100 m-0">
                                <div class="w-10vw h-10vw my-auto">
                                    <imagen clase="border-radius-5px" :fit="true" :src="p.imagen" v-if="p.imagen" />
                                    <imagen clase="border-radius-5px" :fit="true" src="https://socialflow.app/admin/apiv1/imagenes/p1.png" v-else />
                                ...
                                <div class="col my-auto px-0 pl-3">
                                    <div class="row w-100 m-0 letra-gray4-18 fw-600">{{p.afiliado.tradename}}</div>
                                    <div class="row w-100 m-0 letra-azul1-15">{{p.concepto}}</div>
                                    <div class="row w-100 m-0 letra-gray4-18 "  >
                                        <div class="col-auto px-0">{{p.total | currency}}  </div>
                                    </div>
                                </div>
                            </div>
