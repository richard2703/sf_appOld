        ...
        <div class="row w-100 m-0px mt-80px px-3 pt-40px" @click.self="closeModal()">
            ...
            <div class="row w-100 m-0 pb-3">
                <div class="row w-100 m-0 px-0">
                    <div class="row w-100 m-0 justify-content-center py-2" v-if="titulo || texto">
                        ...
                        <div class="col-12 text-center letra-gray3-4-5vw p-0 px-3" v-if="texto">{{texto}}</div>
                        <div class="col-12 text-center letra-azul1-4-5vw p-0 px-3 py-2" v-if="texto2">{{texto2}}</div>
                    </div>
            ...
            <div class="row w-100 m-0 back-color-blanco pb-3 px-2">
                ...
                <div class="row w-100 m-0" v-else>
                    <div class="col-6 px-1" @click="closeModal(); $emit('cancel');">
                        <botonApp :tipo="colorC || 'gris'" :texto="cancelBoton || 'Cancelar'" radius="10px" />
                    </div>
                    <div class="col-6 px-1" @click="click()">
                        <botonApp :texto="boton" :tipo="colorA|| 'azul'" radius="10px" />
                    </div>
                </div>
            </div>
            </div>
