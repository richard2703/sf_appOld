<template>
    <f7-page class="" id="inicio">
        ...
        <div class="vista" >
            <nav-bar tipo="inicio" :backs="true" :title="'Regalos para tu fecha importante'" />
                    ...
                    <div class="row w-100 m-0 px-2">
                        ...
                        <div class="row w-100 m-0 pt-3" v-if="form.activo">
                            ...
                            <div class="row w-100 m-0">
                                <div class="row w-100 m-0 justify-content-center">
                                    <div class="col-6 px-0 overflow-hidden " v-for="p of ciudad" :key="p.id">
                        ...
                        <template  v-else>
                            ...
                            <div class="row w-100 m-0 pt-3" >
                                ...
                                <div class="row w-100 m-0">
                                    <div class="row w-100 m-0 justify-content-center">
                                        <div class="col-6 px-0 overflow-hidden " v-for="p of paginado" :key="p.id">
                                            <cardProducto :data="p" :regalo="true" />
                                        </div>
                                    </div>
                                </div>
