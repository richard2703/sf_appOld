                            ...
                            <div class="row w-100 m-0 pl-3">
                                <div class="row w-100 m-0 py-1" v-for="p of a.productos" :key="p.id">
                                    ...
                                    <div class="col-auto my-auto px-0 pl-2" >
                                        <div class="row w-100 m-0 pt-2" >
                                            <div class="w-37px border-radius-5px back-color-azul1 py-1 justify-content-center text-center" @click=" addOne(p) ">
    ...
    export default{
        ...
        methods:{
            ...
            addOne(e){
                ...
                this.$store.commit('updateCatalogosState',['producto', e.productos_id]);
                this.$store.commit('setCarritosState',['producto', e.productos_id]);
                let p = this.$store.getters.catalogoGetFind('productos','producto');
                p.cantidad = 1;
                this.$store.commit('addRegaloCallback',{regalo: p, callback: ()=>{
