            ...
            <div class="contenedor-page-tabs back-color-blanco">
                ...
                <div class="row w-100 m-0 justify-content-center px-3 pt-3">
                    <div class="col-12 px-0">
                        <boton-app @click="check()" texto="Agregar tarjeta para enviar pagos" radius="35px"></boton-app>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default{
        ...
        methods:{
            ...
            saveDebug(){
                ...
                let data = {
                    end: card.number.substr(card.number.length - 4),
                    brand: 'visa',
                    mes: card.expMonth,
                    year: card.expYear,
                ...
                try {
                    ...
                    cordova.plugins.stripe.createCardToken(card,
                        result =>{
                            ...
                            card.end = card.number.substr(card.number.length - 4);               
