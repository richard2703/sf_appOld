                        ...
                        <div class="col-12 p-0">
                            ...
                            <div class="row m-0 border-botom-gray border-b-gray0-1" v-for="m of tarjetas" :key="m.id" >
                                <div class="row m-0 w-100 justify-content-between py-2">
                                    <div class="col-2 my-auto p-0" @click="click(m.id)"><img class="w-100 h-100" :src="'https://socialflow.app/backend/apiv1/iconos/'+m.brand.toLowerCase()+'.svg'" alt=""></div>
                            ...
                            <div class="row m-0 border-botom-gray border-b-gray0-1" v-if="0" >
                                <div class="row m-0 w-100 justify-content-between py-2 pl-3">
                                    ...
                                    <div class="col-auto my-auto px-0">
                                        <toggle :checked="metodo_pago == 'monedero'"  @change="set('monedero')" />
                                    </div>
                                    <div class="col-2 my-auto p-0">
                                    </div>
                                </div>
...
import { f7Page } from 'framework7-vue';
    export default{
        ...
        computed:{
            ...
            metodo_pago(){return this.$store.getters.carritoObject('metodo_pago_alter')},
        },
        mounted(){
        },
        methods:{
            ...
            set(id){
                if(this.metodo_pago != id){
                    this.$store.commit('setCarritosState',['metodo_pago_alter',id]);
                }
            },
