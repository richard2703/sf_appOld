                ...
                <div class="row w-100 m-0 mt-3">
                    <div class="row w-100 m-0 px-3">
                        ...
                        <div class="col-12 pt-3 mt-4">
                            <inputForm :scroll="true" :offset="50" type="text" :texto="`Nombre ${form.tipo=='party'?'de la party':'de la reunion'}:`" placeholder="" v-model="form.nombre" />
                        </div>
                        <div class="col-12 mt-4">
                        ...
                        <div class="col-12 mt-4 pt-3" >
                            ...
                            <div class="row w-100 m-0 mt-2 border-t-gray1-1 total-regaslo-form">
                                ...
                                <div class="row w-100 m-0 px-2" v-if="form.cooperacion == 'si'" >
                                    <div class="col px-0 letra-gray3-15">Cooperacion por invitado:</div>
                                    <div class="col-auto px-0 letra-azul-20 pr-4" v-if="form.externo=='si'">{{totalCantidad(regalosForm) / (usuariosForm.length + 1) | currency}} MXN</div>
                                    <div class="col-auto px-0 letra-azul-20 pr-4" v-if="form.externo=='no'">{{totalCantidad(regalosForm) / (usuariosForm.length) | currency}} MXN</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row w-100 m-0 pb-3">
                                <div class="row w-100 m-0" v-for="(a, x) of listaRegalosForm" :key="a.id">
                                    <div class="row w-100 m-0 px-2 py-1 ">
                                        ...
                                        <div class="col-auto my-auto px-0 pl-2">
                                            <div class="row w-100 m-0 letra-azul-18">{{a.precio | currency}}</div>
                                        </div>
                                        <div class="col-auto my-auto px-0 pl-2 ">
                                            <boton-icono @click="delConcepto(x)" :noborder="true" icono="remove" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row w-100 m-0 mt-2 border-t-gray0-1">
                                    <div class="row w-100 m-0 px-2">
                                        ...
                                        <div class="col-auto px-0 letra-azul-20 pr-4">{{total(listaRegalosForm) | currency}}</div>
                                    </div>
                                    <div class="row w-100 m-0 px-2" v-if="form.cooperacion == 'si'" >
                                        <div class="col px-0 letra-gray3-17">Cooperacion por invitado:</div>
                                        <div class="col-auto px-0 letra-azul-20 pr-4">{{total(listaRegalosForm) / (usuariosForm.length + 1) | currency}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        data(){
            return{
                ...
                tipo:[
                    ...
                    { id: 'party', nombre: 'Party (Compra un regalo entre varias personas)'},
                ],
                // form:{
