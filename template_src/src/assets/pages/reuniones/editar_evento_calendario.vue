<template>
    <f7-page id="inicio">
        <div class="vista" v-vistak>
            <!-- <nav-bar tipo="inicio" :backs="true" :title="'Editar evento #'+form.id"/> -->
            <nav-bar tipo="inicio" :backs="true" :title="form.nombre"/>
                    ...
                    <div class="row w-100 m-0">
                        ...
                        <div class="row w-100 m-0 pb-2 back-color-blanco ">
                            ...
                            <div class="col-12 m-0" v-if="form.tipo=='party'" >
                                <div class="row w-100 m-0 px-1 letra-gray3-14 ">*Un regalo grupal es 1 o varios productos, servicios y experiencias que puedes comprar entre 1 o mas personas para regalárselas a un tercero.</div>
                            </div>
                            <div class="col-12 mt-3">
                                <inputForm :scroll="true" :offset="50" type="text" :texto="`Nombre ${form.tipo=='party'?'del regalo grupal' :form.tipo=='reunion'?'de la reunión':'del evento'}:` "  v-model="form.nombre" />
                            </div>
                            <div class="col-12 mt-3">
                ...
                <div class="row w-100 m-0 justify-content-center mt-4 pb-5">
                    <div class="row w-100 m-0 justify-content-center mt-2 pb-5">
                        <div class="col-12 px-4 py-3 back-color-blanco" >
                            <botonApp tipo="azul" texto="Guardar y actulizar" radius="30px" @click="save" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        methods:{
            ...
            save(){
                ...
                if(this.form.fecha < this.hoy){
                    swal("","Solo puedes editar eventos futuros","");
                    return;
                }
